...
% Last Modified by GUIDE v2.5 21-May-2008 16:03:16

% Begin initialization code - DO NOT EDIT
clear all; close all; clc;
global X;global temp;global Pat;
...
% --- Executes on selection change in disFunction.
function disFunction_Callback(hObject, eventdata, handles)
% hObject    handle to disFunction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = get(hObject,'String') returns disFunction contents as cell array
%        contents{get(hObject,'Value')} returns selected item from disFunction
guidata(hObject, handles);

% --- Executes during object creation, after setting all properties.
function disFunction_CreateFcn(hObject, eventdata, handles)
% hObject    handle to disFunction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in MDS_check.
function MDS_check_Callback(hObject, eventdata, handles)
% hObject    handle to MDS_check (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of MDS_check
guidata(hObject, handles);


function MDS_Callback(hObject, eventdata, handles)
% hObject    handle to MDS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MDS as text
%        str2double(get(hObject,'String')) returns contents of MDS as a double
guidata(hObject, handles);

% --- Executes during object creation, after setting all properties.
function MDS_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MDS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function clusterindex_Callback(hObject, eventdata, handles)
% hObject    handle to clusterindex (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of clusterindex as text
%        str2double(get(hObject,'String')) returns contents of clusterindex as a double
guidata(hObject, handles);

% --- Executes during object creation, after setting all properties.
function clusterindex_CreateFcn(hObject, eventdata, handles)
% hObject    handle to clusterindex (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in showcluster.
