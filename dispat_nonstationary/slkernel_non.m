function K = slkernel_non(varargin)
...
function K = gauss_kernel(X0, X, sigma,Locdb)
% change in future
w_ssm = 0.75;
%
D1 = slmetric_pw(Locdb, Locdb, 'sqdist');
D3 = slmetric_pw(X0, X, 'sqdist');
% change in future
D2 = (1-w_ssm)*D3+w_ssm*D1;
%
